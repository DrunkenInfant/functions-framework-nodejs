...
describe('request to HTTP function', () => {
    ...
    testData.forEach(test => {
        it(`should return transformed body: ${test.name}`, () => {
            const server = invoker.getServer((req, res) => {
...
describe('GCF event request to event function', () => {
    ...
    testData.forEach(test => {
        it(`should receive data and context from ${test.name}`, async () => {
            ...
            const server = invoker.getServer((data, context) => {
                receivedData = data;
...
describe('CloudEvents request to event function', () => {
    ...
    testData.forEach(test => {
        it(`should receive data and context from ${test.name}`, async () => {
            ...
            assert.notStrictEqual(receivedContext, null);
            assert.strictEqual(receivedContext.specversion, TEST_CLOUD_EVENT.specversion);
            ...
            assert.strictEqual(receivedContext.datacontenttype, TEST_CLOUD_EVENT.datacontenttype);
        });
    });
});
describe('CloudEvents request to cloudevent function', () => {
    ...
    testData.forEach(test => {
        it(`should receive data and context from ${test.name}`, async () => {
            let receivedCloudEvent = null;
            const server = invoker.getServer((cloudevent) => {
            ...
            assert.strictEqual(receivedCloudEvent.specversion, TEST_CLOUD_EVENT.specversion);
            ...
            assert.strictEqual(receivedCloudEvent.datacontenttype, TEST_CLOUD_EVENT.datacontenttype);
