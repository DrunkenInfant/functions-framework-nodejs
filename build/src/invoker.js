...
exports.getServer = exports.getApp = exports.ErrorHandler = exports.registerFunctionRoutes = exports.SignatureType = void 0;
    ...
    return (req, res, next) => {
        ...
        d.on('error', err => {
            if (res.locals.functionExecutionFinished) {
                ...
                logger_1.logAndSendError(err, res);
            }
        });
        d.run(() => {
            process.nextTick(() => {
...
class ErrorHandler {
    ...
    register() {
        process.on('uncaughtException', err => {
            ...
            logger_1.logAndSendError(err, latestRes, killInstance);
        });
        ...
        process.on('exit', code => {
            logger_1.logAndSendError(new Error(`Process exited with code ${code}`), latestRes);
        });
